import type { FrontChatListItem } from './types'

export const FRONTUI_PLACEHOLDER_AVATAR =
  'https://images.unsplash.com/photo-1617978440019-a4855b590db2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxib2tlJTIwcGxhY2Vob2xkZXIlMjBhdmF0YXJ8ZW58MXx8fHwxNzc1NDI2MjgwfDA&ixlib=rb-4.1.0&q=80&w=256'
