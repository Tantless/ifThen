  ...
  it('maps persisted llm settings into the form state', () => {
    expect(
      buildSettingsFormState([
        ...
        { setting_key: 'llm.simulation_model', setting_value: 'gpt-4o', is_secret: false },
      ...
      apiKey: 'secret-key',
      chatModel: 'gpt-5.4',
      simulationBaseUrl: 'https://simulation.example.test/v1',
      simulationApiKey: 'simulation-secret',
